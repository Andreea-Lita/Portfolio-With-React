                ...
                <Container>
                    <div className="presentation-container">
                        ...
                        <section className="slide">
                            ...
                            <hr />
                            <img src={picture1} alt="Modern Agricultural Warehouse" className="background-image" style={{ opacity: 0.5 }} />
                            <div className="content">
                                <Container size="md-12 just ">
                                    <Col size="md-4 just">
                                        <h2 id="setName" style={{ color: 'yellow' }} >Andreea and Costinel Malaiasi</h2>
                                    </Col>
